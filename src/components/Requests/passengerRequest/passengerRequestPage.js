...
import { deleteRequest, getPassengerRide } from "../../../redux/action/request/passengerRequestsActions";
import {deleteRequestForRide} from "../../../redux/action/request/driverRequestsActions";
      ...
      requests.map((request) => (
        <div key={request._id} className="card mb-3">
          <div className="card-body">
            ...
            <p className="card-text">
              <strong>Ride Date:</strong> {request.ride.rideDate}
            </p>
            <p className="card-text">
              <strong>Ride Time:</strong> {request.ride.rideTime}
            </p>
            <p className="card-text">
              <strong>Estimated Duration:</strong> {request.ride.estimatedDuration}
            </p>
            <p className="card-text">
